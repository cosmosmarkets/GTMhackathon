...
export function Teaser({
  ...
  return (
    <div className="animate-fade-up rounded-3xl border border-white/10 bg-ink-800/80 p-6 backdrop-blur sm:p-8">
      ...
      <p className="mt-4 font-serif text-2xl leading-snug text-bone text-balance sm:text-3xl">
        {voiceprint.tagline}
      </p>
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        {voiceprint.traits.map((t) => (
          <span
            key={t}
            className="rounded-full border border-fern/30 bg-fern/5 px-3 py-1 text-sm text-fern-bright"
          >
            {t}
          </span>
        ))}
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-ink-700/50 p-5">
        <div className="font-mono text-[0.7rem] uppercase tracking-[0.18em] text-fern/80">
          Rhythm
        </div>
        <p className="mt-1.5 leading-relaxed text-bone/90">
      ...
      <div className="relative mt-3 select-none">
        <div className="space-y-3 rounded-2xl border border-white/10 bg-ink-700/40 p-5 blur-[6px]">
          <div className="h-3 w-1/3 rounded bg-white/20" />
          <div className="h-3 w-11/12 rounded bg-white/10" />
          <div className="h-3 w-4/5 rounded bg-white/10" />
          <div className="mt-4 h-3 w-1/4 rounded bg-white/20" />
          <div className="h-3 w-10/12 rounded bg-white/10" />
        </div>
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="rounded-full border border-fern/30 bg-ink/80 px-4 py-1.5 text-sm text-fern-bright">
